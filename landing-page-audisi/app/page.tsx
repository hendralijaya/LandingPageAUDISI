...
import { Logo, LatarBelakangMobile, LatarBelakangTab, HeroMobile, HeroTab } from '@/public/img';
  ...
  return (
    <div className="">
      ...
      <div className="px-4 md:px-6">
        ...
        >
          <div className="bg-[url('@/public/img/pattern/pattern-mobile.png')] bg-cover bg-no-repeat">
            ...
            <Image src={HeroMobile} alt="hero" className="rounded-ee-xl rounded-es-xl md:hidden" layout="cover" />
            <Image src={HeroTab} alt="hero" className="rounded-ee-xl rounded-es-xl hidden md:block w-full" layout="cover" />
          </div>
      ...
      <div className="p-4 space-y-4 md:p-6 md:space-y-6">
        ...
        <Card hasImage={false}>
          <div className="space-y-4 md:flex md:space-y-0 md:gap-x-6">
            <RoundedButton className="bg-red-950 hover:bg-red-500 md:w-36 md:h-16 rounded-full">
      ...
      <div className="p-4 space-y-4 md:p-6 md:space-y-6">
        ...
        <Image src={LatarBelakangTab} alt="latar-belakang" className="hidden md:block object-contain w-full" layout="responsive" />
      </div>
      ...
      <div className="p-4 flex flex-col gap-y-4">
        ...
        <Card hasImage={true} className="p-0 flex flex-col">
          ...
          <Image src={VisiTab} alt="hero" className="hidden md:block md:rounded-t-xl object-contain w-full" layout="responsive" width={800} height={400} />
